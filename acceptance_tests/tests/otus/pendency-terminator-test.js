...
suiteArray = [
    ...
    describe('Scenario 2.2 Eliminate a pendency', () => {

        test('Eliminate a pendency', async () => {
            const activitiesDataToAdd = [ activityData.CSJ.paper ];
            const activityPage = new ActivitiesPage(pageOtus.page);
            await addActivitiesUnitaryAndCheck(activitiesDataToAdd);
            await activityPage.selectActivityAndClickOnFillButton("CSJ", 0);
    ...
    xdescribe('Scenario #2.2: Add 1 by 1', () => {
        ...
        xtest('2.2a Only one of paper type', async() => {
            const activitiesDataToAdd = [ activityData.CSJ.paper ];
            await addActivitiesUnitaryAndCheck(activitiesDataToAdd);
        });
    ...
    xdescribe('Scenario #2.3: Add activity blocks', () => {
        ...
        xtest('2.3a Add only 1 block of PAPER type', async() => {
        ...
        xtest('2.3b Add only 1 block of ON-LINE type', async() => {
            await checkActivityItemsIsClear();
        ...
        xtest('2.3c Add 2 blocks of same type', async() => {
            await checkActivityItemsIsClear();
            await activitiyAdderPage.switchTypeToOnline();
        ...
        xtest('2.3d Add blocks AND unit activities', async() => {
            await checkActivityItemsIsClear();
            await activitiyAdderPage.switchTypeToOnline();
    ...
    xdescribe('Scenario #2.4: Delete one activity from temporary array', () => {
        ...
        xtest('2.4b Delete one activity from MIDDLE of temporary array', async() => {
            await deleteItem(1);
        });

        xtest('2.4c Delete one activity from END of temporary array', async() => {
